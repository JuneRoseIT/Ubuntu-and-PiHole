...
Selected the USB drive under Device.

Clicked SELECT and chose the Ubuntu Server ISO.

Left the recommended boot settings in place.

Clicked START.

Confirmed that the USB could be erased.
...
![Ubuntu Server boot menu](02-ubuntu-install-menu.jpg)
...
![Ubuntu Server network configuration](03-ubuntu-network-config.jpg)
...
![Ubuntu storage confirmation](04-ubuntu-storage-confirmation.jpg)
...
![Ubuntu Server installation complete](05-ubuntu-install-complete.jpg)
...
![Ubuntu Server login and system verification](06-server-login-and-hostname.jpg)
...
![Testing Ubuntu Server network connectivity](07-network-connectivity-test.jpg)
...
![Pi-hole installation complete](08-pihole-install-complete.jpg)
...
![Pi-hole service status](10-pihole-service-status.jpg)
...
![Windows 11 DNS configuration](09-windows-dns-settings.jpg)
...
![Testing DNS resolution with nslookup](11-dns-resolution-test.jpg)

I checked two things:

The DNS server shown by nslookup was my Pi-hole server.

google.com still successfully resolved to an IP address.
...
![Pi-hole query log receiving client requests](12-pihole-query-log.jpg)
...
![Configuring Ubuntu laptop lid behavior](13-lid-switch-logind-config.jpg)
...
Server has its expected address
...
DNS listening and blocking enabled

nslookup google.com

DNS path

Lookup uses Pi-hole and resolves
